...
@Slf4j
public class RunAssigneeTaskByUelProcessDemo extends FlowableEngineUtil {
    SimplePropertyPreFilter identityLinkFilter
            = new SimplePropertyPreFilter(IdentityLink.class,
            "type","userId","groupId");
    ...
    public void runAssigneeTaskByUelProcessDemo() {
        ...
        //部署流程
        deployResource("processes/AssigneeTaskByUelProcess.bpmn20.xml");
        ...
        Map<String, Object> varMap = ImmutableMap
                .of("taskAssigneeBean", taskAssigneeBean);
        //启动流程
        ProcessInstance procInst = runtimeService
                .startProcessInstanceByKey("assigneeTaskByUelProcess", varMap);
